  ...
  const fetchEmployee = async () => {
    try {
      ...
      setFormData({
        ...
        role: response.role || '',
        salary: response.salary ? response.salary.toString() : '',
        aadharNumber: response.aadharNumber || '',
        address: response.address || '',
        dateOfJoining: response.dateOfJoining ? response.dateOfJoining.split('T')[0] : ''
      });
    } catch (error) {
            ...
            <div className="flex items-center justify-between mb-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">Update the employee information below</p>
                </div>
              </div>
              <ModernButton
                variant="secondary"
